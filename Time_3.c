// файл виміру середього часу роботи третього алгоритма
#include "Time.h"
clock_t time_sort_3(int const p, int const n, int const mod) // функція виміру
                                        //середнього часу роботи першого алгоритму
{
