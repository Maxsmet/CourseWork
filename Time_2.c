// файл виміру середього часу роботи другого алгоритма
#include "Time.h"
clock_t time_sort_2(int const p, int const n, int const mod) // функція виміру середнього
                                                    //часу роботи другого алгоритму
{
